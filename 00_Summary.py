    ...
    "columnDefs": [
        ...
        {   'headerName': '2022',
             ...
             'children': [
                 ...
                 {'field': 'Dec22', 'columnGroupShow':'open', 'editable':False, 'resizable':False, 'suppressSizeToFit':True, 'suppressAutoSize':True, 'filter':False, 'width':75, 'cellStyle':{'background-color':'lightblue'}},
                 {'field': 'Total22', 'headerName':'Total', 'columnGroupShow':'closed', 'editable':False, 'resizable':False, 'suppressSizeToFit':True, 'suppressAutoSize':True, 'filter':False, 'width':100, 'cellStyle':{'background-color':'cadetblue'}, 
...
with col2:
    st.markdown("Latest Forecast Available: 5+7 Forecast.")
    st.markdown("Latest Actuals Updated: through May 2023.")
